                ...
                $("#comment_form_container").after(`
                    <div class="comments-list-main" id="comments-mains" name="comments-mains">
                        <div id="commentform_title">
                            ...
                            <!--<span class="refresh_btn"><a  onclick="${refreshcomment_onclick}" id="lnk_RefreshComment" runat="server" clientidmode="Static">刷新评论</a></span>-->
                        </div>
        ...
        if ($(".login_tips").length > 0) {
            ...
            $(".login_tips").html(`
                <div class="login_tips_content">
                    发表评论请 <a rel="nofollow"  class="underline tologin" onclick="return login('commentform');">登录</a>
                </div>
            `)
            $(".login_tips").after(`
                <p id="commentbox_opt">
                                        ...
                                        ${isMobile ? `
                                            <div class="comments_action">
                                                <span class="comment_vote_box"> 
                                                    ...
                                                    <a  class="comment_digg" onclick="${digg_click}"><i class="iconfont icon-zan" ></i>${digg_num === "0" ? "赞" : digg_num}</a>
                                                    <a  class="comment_burry" onclick="${burry_click}"><i class="iconfont icon-zan1" ></i>${burry_num === "0" ? "踩" : burry_num}</a>
                                                </span>
                                            </div>
                                        `: ""}
                                    </div>
