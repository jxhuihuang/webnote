                ...
                <article>
                    ...
                    `
                                <div class="post-footer">
                                    ...
                                    <div>
                                        ${(obj.footInfo).reads ? `<span class="reads"><i class="iconfont icon-look  mr5"/><em>${(obj.footInfo).reads}</em>  </span>` : ''}
                                        ${(obj.footInfo).coments ? `<span class="coments"><a href="${obj.link}#comments" style="color:inherit"><i class="iconfont icon-pinglun  mr5"  /><em>${(obj.footInfo).coments}</em></span></a>` : ''}
                                        ${(obj.footInfo).diggs ? `<span class="diggs"><span class="icon-box"><i class="iconfont icon-zan  mr5" /></span> <em> ${(obj.footInfo).diggs} </em></span>` : ''}
                                        ${isadmin ? `<span class="edits"><a href="${(obj.footInfo).editLink}" target="_blink" style="color:inherit"><i class="iconfont icon-bianji3  mr5" />编辑</a></span>` : ``}
                                    </div>
                                </div>
                            `: ``
                }
