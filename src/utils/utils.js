...
let bolgdefaultAvatars =
  "https://images.cnblogs.com/cnblogs_com/webqiand/762723/o_timg.jpg"; //头像
let userdefaultAvatars =
  "https://images.cnblogs.com/cnblogs_com/webqiand/1381628/o_200909063356user_avatar5.png"; //用户默认头像 https://images.cnblogs.com/cnblogs_com/webqiand/1381628/o_uesravatars.png
let loginAvatars =
  "https://images.cnblogs.com/cnblogs_com/webqiand/1381628/o_login.png"; //未登录时头像
const colorChars = [
  "#036564",
  "#EB6841",
  "#3FB8AF",
...
// 去除两侧的空格
function trim(str) {
  let typeName = Object.prototype.toString.call(str).slice(8, -1).toLowerCase();
  if (typeName == "null" || typeName == "undefined") {
    return "";
  }
  if (typeName != "string") {
...
function stringToArry(strings) {
  ...
  var stringsArry = [];
  strings =
    strings.lastIndexOf(",") == strings.length - 1
      ? strings.substring(0, strings.lastIndexOf(","))
      : strings;
...
function addEventListener() {
  if (isMobile) {
    ...
    httpsType === "https://"
      ? addjs("https://blog-static.cnblogs.com/files/webqiand/mobiles.js?v=1.1")
      : addjs("http://www.webnotes.tk/public/mobiles.js?v=1.1"); //https://blog-static.cnblogs.com/files/webqiand/mobiles.js
    var script = document.createElement("script");
    script.innerHTML = `
...
function getDateDiff(dateTimeStamp = "") {
  dateTimeStamp = dateTimeStamp
    ? DateFormat("yyyy/MM/dd hh:mm", dateTimeStamp)
    : "";
  if (dateTimeStamp === "") {
    return "";
  }
