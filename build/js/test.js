...
/***/ (function(module, exports, __webpack_require__) {
	...
	var isInMaintain = _utils.BootCommons.isInMaintain,
	    archivePrivate = _utils.BootCommons.archivePrivate,
	    currentUrl = _utils.BootCommons.currentUrl,
	    isGray = _utils.BootCommons.isGray; //isInMaintain:显示的页面  false 博客页面  true 维护页面
	...
	var Test = function (_Component) {
	    ...
	    _createClass(Test, [{
	        ...
	        value: function componentWillMount() {
	            ...
	            (0, _sidebar.sideBar)(_json.userinfo); //加载侧边栏
	            // this.setState({
	            //     blogInfo:userinfo,
	            // })
	        ...
	        value: function componentDidMount() {
	            ...
	            var txts = 'ZIPCode<span class="tag-count">(1)</span>';
	            var numval = "(1)";
	            // /\<.*?\/\>/g
	            var txts_html = txts.replace(/\<.*?\>.*?\<\/.*?\>/g, "");
	            var nums = (0, _utils.getLastbrackval)(numval);
	            ...
	            var backlist_src = "https://www.cnblogs.com/bigweb/gallery/682944.html";
	            var src = "http://n.sinaimg.cn/news/1_img/upload/cf3881ab/67/w1000h667/20200710/1349-iwasyei8902095.jpg"; //target="_New"
	            $(".forFlow").append('<div class="gallery"><div class="galleryMain" id="gallery_info"></div></div>');
	            var title = "浅谈响应式瀑布流的实现方式";
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                _react.Fragment,
	                null,
	                _react2.default.createElement(_header2.default, { blogInfo: _json.userinfo })
	            );
	        }
	    }]);
